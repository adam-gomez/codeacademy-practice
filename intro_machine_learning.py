# -- Supervised Learning -- 
# Machine learning can be branched into supervised and unsupervised categories
# Supervised learning can be further grouped into classification vs regression problems
# Regression: Trying to predict a continuous-valued output
# Classification: Trying to predict a discrete number of values

# Example of a Naive Bayes classifier for NLP to determine if a statement is 'positive' or 'negative'
